...
// All content in this module is Unix/macOS-specific (uses libc types like iovec, stat64,
// mode_t, etc. that are not available on Windows).
// On Windows, this module is empty. The consumers (fs module, file_traits) are also
